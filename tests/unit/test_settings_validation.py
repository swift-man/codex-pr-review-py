...
def test_local_review_env_example_prefers_gpt_56_sol_budget() -> None:
...
def test_extended_reasoning_effort_allows_model_specific_fallback_downgrade(
    monkeypatch: pytest.MonkeyPatch,
    effort: str,
) -> None:
...
def test_codex_model_fallbacks_can_be_disabled(
    ...
    assert s.codex_model_sequence == ("gpt-5.6-sol",)
